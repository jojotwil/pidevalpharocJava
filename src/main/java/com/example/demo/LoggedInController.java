...
public class LoggedInController implements Initializable {
    private com.example.demo.AuthenticationService authService;
    ...
    private com.example.demo.ProfilePageController profilePageController;
    @Override
    ...
    void handleProfileButtonClick(ActionEvent event) {
        try {
            ...
            com.example.demo.ProfilePageController profileController = loader.getController();
