...
public class CommandeDetailsWindow {
    ...
    public void display(Commande commande) {
        ...
        if (produits != null && !produits.isEmpty()) {
            ...
            try {
                imagee = new Image( premierProduit.getImage());
        ...
        String cssFile = "/com/example/demo/CSS/styleHayfa.css";
        URL cssUrl = getClass().getResource(cssFile);
        if (cssUrl != null) {
            scene.getStylesheets().add(cssUrl.toExternalForm());
        } else {
            System.err.println("Le fichier CSS " + cssFile + " n'a pas été trouvé.");
        }
